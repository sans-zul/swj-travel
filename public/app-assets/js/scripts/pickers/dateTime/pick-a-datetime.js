...
==========================================================================================*/
  (function (window, document, $) {
    ...
    // Format Date Picker
    $('.format_tanggal').pickadate({
      format: 'yyyy-mm-dd'
    });

    // Format Date Picker
    $('.format_tanggal_jam').pickadate({
      format: 'yyyy-mm-dd'
    });
    ...
    //   ranges: {
    //     'Today': [moment(), moment()],
    //     'Yesterday': [moment().subtract('days', 1 /*, 'days'*/ ), moment().subtract('days', 1 /*, 'days'*/ )],
    //     'Last 7 Days': [moment().subtract('days', 6 /*, 'days'*/ ), moment()],
    //     'Last 30 Days': [moment().subtract('days', 29 /*, 'days'*/ ), moment()],
    //     'This Month': [moment().startOf('month'), moment().endOf('month')],
    //     'Last Month': [moment().subtract('month', 1 /*, 'month' */ ).startOf('month'), moment().subtract('month', 1 /*, 'month' */ ).endOf('month')]
    //   }
    // });
